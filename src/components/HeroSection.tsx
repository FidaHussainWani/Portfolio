    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div className="relative z-10 text-center max-w-4xl mx-auto px-6" style={{ y: textY, opacity }}>
        ...
        >
          ...
          >
            <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full border-4 border-primary/20 overflow-hidden shadow-2xl shadow-primary/10">
              <img
                src="/profile.png"
                alt="Fida Hussain"
        ...
        >
          {[
            { icon: Github, href: "https://github.com/FidaHussainWani", label: "GitHub" },
            { icon: Linkedin, href: "https://linkedin.com/in/Fida-Wani", label: "LinkedIn" },
            { icon: Mail, href: "mailto:Fidawani20022@gmail.com", label: "Email" },
            { icon: Phone, href: "tel:+918803942460", label: "Phone" },
