...
const links = [
  { icon: Mail, label: "Fidawani20022@gmail.com", href: "mailto:Fidawani20022@gmail.com" },
  { icon: Phone, label: "+91 8803942460", href: "tel:+918803942460" },
  { icon: Github, label: "github.com/FidaHussainWani", href: "https://github.com/FidaHussainWani" },
  { icon: Linkedin, label: "linkedin.com/in/Fida-Wani", href: "https://linkedin.com/in/Fida-Wani" },
];
  ...
  return (
    <div className="text-center">
      ...
      <p className="text-muted-foreground mb-8 text-sm max-w-sm mx-auto">
        Open to opportunities in software development, AI-powered systems, and solving computational problems.
      </p>
